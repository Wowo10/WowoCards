...
class OrientedBoundingBox // Used in the BoundingBoxTest
{
	public:
		...
		OrientedBoundingBox();
		OrientedBoundingBox (const sf::Vector2f& pos);
...
bool PixelPerfectTest(const sf::Sprite& Object1,const sf::Vector2f& pos, sf::Uint8 AlphaLimit = 0);
...
///for recolored textures; create texture and bitmask from (manual loaded) img
