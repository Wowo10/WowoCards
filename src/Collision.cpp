...
OrientedBoundingBox::OrientedBoundingBox (const sf::Vector2f& pos)
{
	Points[0] = pos;
	Points[1] = pos;
	Points[2] = pos;
...
bool PixelPerfectTest(const sf::Sprite& Object1, const sf::Vector2f& pos, sf::Uint8 AlphaLimit)
{
	sf::FloatRect Intersection;
	sf::FloatRect vertex(pos.x, pos.y, 1, 1);
	if (Object1.getGlobalBounds().intersects(vertex, Intersection))
	{
		sf::IntRect O1SubRect = Object1.getTextureRect();

		sf::Uint8* mask1 = Bitmasks.GetMask(Object1.getTexture());

		sf::Vector2f o1v = Object1.getInverseTransform().transformPoint(Intersection.left, Intersection.top);
...
bool CreateTextureAndBitmask(sf::Texture &LoadInto, sf::Image& img)
{
	if (!LoadInto.loadFromImage(img))
		return false;
...
bool BoundingBoxTest(const OrientedBoundingBox& box1, const OrientedBoundingBox& box2)
{
	OrientedBoundingBox OBB1 = box1;
	OrientedBoundingBox OBB2 = box2;
...
bool BoundingBoxTest(const sf::Sprite& Object1, const OrientedBoundingBox& box2)
{
	OrientedBoundingBox OBB1 (Object1);
	OrientedBoundingBox OBB2 = box2;
